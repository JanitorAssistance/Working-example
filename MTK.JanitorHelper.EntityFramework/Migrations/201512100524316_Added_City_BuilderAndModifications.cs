namespace MTK.JanitorHelper.Migrations
{
    ...
    public partial class Added_City_BuilderAndModifications : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        SocialSecurityNumber = c.String(maxLength: 13),
                        StreetAddressId = c.Int(),
                        StreetAddressNrCode = c.String(),
                        OtherInfo = c.String(),
                        IsDeleted = c.Boolean(nullable: false),
                        DeleterUserId = c.Long(),
                        DeletionTime = c.DateTime(),
            ...
            AlterTableAnnotations(
                ...
                {
                    { 
                        "DynamicFilter_StreetAddress_SoftDelete",
                        new AnnotationValues(oldValue: null, newValue: "EntityFramework.DynamicFilters.DynamicFilterDefinition")
                    },
                });
            ...
            AlterTableAnnotations(
                ...
                {
                    { 
                        "DynamicFilter_SMCompany_SoftDelete",
                        new AnnotationValues(oldValue: null, newValue: "EntityFramework.DynamicFilters.DynamicFilterDefinition")
                    },
                });
