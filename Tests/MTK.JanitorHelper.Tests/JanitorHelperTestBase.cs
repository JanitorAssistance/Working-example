...
namespace MTK.JanitorHelper.Tests
{
    public abstract class JanitorHelperTestBase : AbpIntegratedTestBase
    {
        protected JanitorHelperTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<JanitorHelperApplicationModule>();
            modules.Add<JanitorHelperDataModule>();
        }

        public void UsingDbContext(Action<JanitorHelperDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<JanitorHelperDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<JanitorHelperDbContext, T> func)
        {
            T result;
